...
import com.lxisoft.domain.UserResponse;
import com.lxisoft.repository.UserResponseRepository;
import com.lxisoft.service.UserResponseService;
import com.lxisoft.service.dto.UserResponseDTO;
import com.lxisoft.service.mapper.UserResponseMapper;
...
public class UserResponseResourceIntTest {
    ...
    private static final Long DEFAULT_REPLY_ID = 1L;
    private static final Long UPDATED_REPLY_ID = 2L;
    ...
    public void createUserResponse() throws Exception {
        ...
        assertThat(testUserResponse.getComplaintId()).isEqualTo(DEFAULT_COMPLAINT_ID);
        assertThat(testUserResponse.getCommentId()).isEqualTo(DEFAULT_COMMENT_ID);
        assertThat(testUserResponse.getReplyId()).isEqualTo(DEFAULT_REPLY_ID);
    ...
    public void getAllUserResponses() throws Exception {
        ...
        restUserResponseMockMvc.perform(get("/api/user-responses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].complaintId").value(hasItem(DEFAULT_COMPLAINT_ID.intValue())))
            .andExpect(jsonPath("$.[*].commentId").value(hasItem(DEFAULT_COMMENT_ID.intValue())))
            .andExpect(jsonPath("$.[*].replyId").value(hasItem(DEFAULT_REPLY_ID.intValue())))
    ...
    public void getUserResponse() throws Exception {
        ...
        restUserResponseMockMvc.perform(get("/api/user-responses/{id}", userResponse.getId()))
            ...
            .andExpect(jsonPath("$.complaintId").value(DEFAULT_COMPLAINT_ID.intValue()))
            .andExpect(jsonPath("$.commentId").value(DEFAULT_COMMENT_ID.intValue()))
            .andExpect(jsonPath("$.replyId").value(DEFAULT_REPLY_ID.intValue()))
    ...
    public void updateUserResponse() throws Exception {
        ...
        assertThat(testUserResponse.getComplaintId()).isEqualTo(UPDATED_COMPLAINT_ID);
        assertThat(testUserResponse.getCommentId()).isEqualTo(UPDATED_COMMENT_ID);
        assertThat(testUserResponse.getReplyId()).isEqualTo(UPDATED_REPLY_ID);
