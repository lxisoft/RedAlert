...
public class PostResourceIntTest {
    ...
    private static final Alert DEFAULT_ALERT_LEVEL = Alert.RED;
    private static final Alert UPDATED_ALERT_LEVEL = Alert.ORANGE;
    ...
    public void createPost() throws Exception {
        ...
        assertThat(testPost.getAlertLevel()).isEqualTo(DEFAULT_ALERT_LEVEL);
        ...
        assertThat(testPost.getLatitude()).isEqualTo(DEFAULT_LATITUDE);
        assertThat(testPost.getLongitude()).isEqualTo(DEFAULT_LONGITUDE);
    }
    ...
    public void getAllPosts() throws Exception {
        ...
        restPostMockMvc.perform(get("/api/posts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].alertLevel").value(hasItem(DEFAULT_ALERT_LEVEL.toString())))
    ...
    public void getPost() throws Exception {
        ...
        restPostMockMvc.perform(get("/api/posts/{id}", post.getId()))
            ...
            .andExpect(jsonPath("$.alertLevel").value(DEFAULT_ALERT_LEVEL.toString()))
    ...
    public void updatePost() throws Exception {
        ...
        updatedPost
            .alertLevel(UPDATED_ALERT_LEVEL)
        ...
        Post testPost = postList.get(postList.size() - 1);
        assertThat(testPost.getAlertLevel()).isEqualTo(UPDATED_ALERT_LEVEL);
        ...
        assertThat(testPost.getLatitude()).isEqualTo(UPDATED_LATITUDE);
        assertThat(testPost.getLongitude()).isEqualTo(UPDATED_LONGITUDE);
    }
