...
public interface CommentResourceApi {
    ...
    @ApiOperation(value = "saveCommentInComplaint", nickname = "saveCommentInComplaintUsingPOST", notes = "", response = CommentDTO.class, tags={ "comment-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = CommentDTO.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/complaint/comment",
        produces = "*/*", 
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<CommentDTO> saveCommentInComplaintUsingPOST(@ApiParam(value = "comment" ,required=true )  @Valid @RequestBody CommentDTO commentDTO);
