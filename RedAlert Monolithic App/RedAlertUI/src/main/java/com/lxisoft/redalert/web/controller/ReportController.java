...
public class ReportController {
	...
	*/
	ResponseEntity<List<ReportDTO>> reportDto = reportResourceApi.findAllByPostUsingGET(postId, null, null, null, null, null, null, null, null, null, null);
	//System.out.println("report types ..************** "+reportDto.getBody().get(0));
	...
	{
		System.out.println("mapp sizeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"+reportMap.size());
	...
	System.out.println("fake count: "+ reportMap.get("FAKE")+"prank count: "+reportMap.get("PRANK")+"Solve count: "+reportMap.get("SOLVED")+"support count: "+reportMap.get("SUPPORT")+"timed out count: "+reportMap.get("TIMEDOUT"));
